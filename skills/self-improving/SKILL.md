---
name: self-improving
description: Self-improving agent with proactive self-reflection. Automatically learns from user corrections, stores preferences in tiered local memory (~/.self-improving/), and applies accumulated knowledge to future interactions. Use when you want the agent to learn and adapt over time.
...
Never store credentials, health data, or third-party personal info. See `boundaries.md`.
